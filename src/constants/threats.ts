...
export const THREAT_LIBRARY: PlantThreat[] = [
  ...
  },
  {
    ...
    type: 'pest',
    icon: '🦗',
    affects: ['Eggplant', 'Radish', 'Cabbage', 'Broccoli', 'Kale', 'Arugula'],
  ...
  },
  {
    ...
    type: 'pest',
    icon: '🐌',
    affects: ['Lettuce', 'Strawberry', 'Cabbage', 'Basil'],
  ...
  },
  {
    ...
    type: 'pest',
    icon: '🕷️',
    affects: ['Tomato', 'Pepper', 'Cucumber', 'Green Beans', 'Strawberry'],
  ...
  },
  {
    ...
    type: 'disease',
    icon: '🌫️',
    affects: ['Cucumber', 'Zucchini', 'Gourd/Squash', 'Pea'],
  ...
  },
  {
    ...
    type: 'disease',
    icon: '🍄',
    affects: ['Strawberry', 'Lettuce', 'Tomato'],
